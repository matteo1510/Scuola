package com.mycompany.calcolatricejfx;
...
void handleOperazioni(ActionEvent event) {
    ...
    lblCronologia.setText(valoreCorrente + " " + operazione);
}
...
void handleUguale(ActionEvent event) {
    ...
    double secondoNumero = Double.parseDouble(lblRisultato.getText());
    ...
    lblCronologia.setText(lblCronologia.getText() + " " + secondoNumero + " =");
    lblRisultato.setText(String.valueOf(valoreCorrente));
